...
int main(){
    ...
    cout << "Well, " << name
         ...
         << endl;
    string barEvents = "incom";
    while (barEvents == "incom"){ 
        cout << "Your in a Bar, only 3 heads in the room. Yours, a man sitting" <<
        " in the shadow's playing with a deck of cards and the barmaid."<<
        "\nWhat do you do?\n";
        cin >> text;
        if (text == "alcohol" || text == "barmaid" || text == "drink"){
        cout << "\nYou walk slowly to the bar, making eye contact with the" <<
            " barmaid as you swagger over\n\n\"What you drinking?" <<
            " Heads up we only have Beer and Whiskey\"\n";
        }
        if (text == "cards" || text == "man" || text == "play"){
