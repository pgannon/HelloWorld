...
void cardgame() {
    ...
    while (repeat == true) {
        ...
        if (gameState == "gameOverLose" ) {
            cout << "You Lose\n" << endl;
            cout << "Shady Man:- \"HAHA, nobody beats me! How about another game?\"\n" << endl;
        ...
        if (text == "yes" || text == "y") {
            ...
            cout << "Shady Man:- \"Great! Here we go!\"\n" << endl;
        ...
        if (text == "no" || text == "n") {
             cout << "Shady Man:- \"I dont blame ya, I wouldn't want to play me neither HAHA!\"\n" << endl;
