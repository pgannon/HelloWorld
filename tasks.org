...
#+CAPTION: Clock summary at [2018-01-16 Tue 16:27]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
...
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |   8.3 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   3.1 |
| Adding numbers on wt                                                        |         | 0:44 |   |   2.8 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   7.7 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   5.3 |
| Practice C++                                                                |         | 1:28 |   |   5.5 |
| Reading "Learn C++" chapter 1                                               |         | 2:33 |   |   9.6 |
| Cleaning up tasks.org                                                       |         | 0:38 |   |   2.4 |
| Making 21 game                                                              |         | 4:38 |   |  17.4 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   2.3 |
| Discussing a task with NI                                                   |         | 0:38 |   |   2.4 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |  11.1 |
| Studying different loops etc etc                                            |         | 0:32 |   |   2.0 |
| Writing a text base adventure                                               |         | 3:45 |   |  14.1 |
| Comparing NI and mines Text Adv                                             |         | 0:48 |   |   3.0 |
