...
#+CAPTION: Clock summary at [2018-01-11 Thu 17:01]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *11:44* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 11:44   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   6.5 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  18.9 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   7.1 |
| Adding numbers on wt                                                        |         | 0:44 |   |   6.2 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |  17.5 |
| Attempt to use wt solo                                                      |         | 1:24 |   |  11.9 |
| Practice C++                                                                |         | 1:28 |   |  12.5 |
| Reading "Learn C++" chapter 1                                               |         | 2:00 |   |  17.0 |
| Cleaning up tasks.org                                                       |         | 0:16 |   |   2.3 |
