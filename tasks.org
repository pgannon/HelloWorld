...
#+CAPTION: Clock summary at [2018-01-25 Thu 12:06]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
...
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |   3.3 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   1.2 |
| Adding numbers on wt                                                        |         | 0:44 |   |   1.1 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   3.1 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   2.1 |
| Practice C++                                                                |         | 1:28 |   |   2.2 |
| Reading "Learn C++"                                                         |         | 6:58 |   |  10.4 |
| Cleaning/Updating tasks.org                                                 |         | 2:45 |   |   4.1 |
| Making 21 game                                                              |         | 4:38 |   |   6.9 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   0.9 |
| Discussing a task with NI                                                   |         | 4:40 |   |   7.0 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |   4.4 |
| Studying different loops etc etc                                            |         | 0:32 |   |   0.8 |
| Writing a text base adventure                                               |         | 5:03 |   |   7.6 |
| Comparing NI and mines Text Adv                                             |         | 0:48 |   |   1.2 |
| Trying to get ERC to work                                                   |         | 1:37 |   |   2.4 |
| Writing Tic Tac Toe game                                                    |         | 3:25 |   |   5.1 |
| Comparing NI and mines TicTacToe                                            |         | 0:12 |   |   0.3 |
| Look for C++ tasks online                                                   |         | 0:19 |   |   0.5 |
| Writing a Number Pyramid                                                    |         | 2:18 |   |   3.4 |
| Comparing NI and mines Pyramid                                              |         | 0:33 |   |   0.8 |
| Writing a Bar Chart                                                         |         | 3:32 |   |   5.3 |
| Comparing NI and mines Bar Charts                                           |         | 0:05 |   |   0.1 |
| Writing New RPG                                                             |         | 4:36 |   |   6.9 |
| Discussing NI and mines New RPG                                             |         | 3:21 |   |   5.0 |
| Researching Arrays                                                          |         | 0:27 |   |   0.7 |
| Looking up C++ online for RPG                                               |         | 0:31 |   |   0.8 |
| Writing a Travel Cal                                                        |         | 1:55 |   |   2.9 |
| Discussing NI and mines Travel Cal                                          |         | 0:50 |   |   1.2 |
| Try to write new 21 game                                                    |         | 1:33 |   |   2.3 |
...
| Writing a Math Quiz                                                         |         | 1:28 |   |   2.2 |
| Comparing NI and mines Math Quiz                                            |         | 0:32 |   |   0.8 |
