...
#+CAPTION: Clock summary at [2018-01-17 Wed 15:29]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *31:38* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 31:38   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   2.4 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |   7.0 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   2.6 |
| Adding numbers on wt                                                        |         | 0:44 |   |   2.3 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   6.5 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   4.4 |
| Practice C++                                                                |         | 1:28 |   |   4.6 |
| Reading "Learn C++" chapter 1                                               |         | 2:33 |   |   8.1 |
| Cleaning up tasks.org                                                       |         | 0:59 |   |   3.1 |
| Making 21 game                                                              |         | 4:38 |   |  14.6 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   1.9 |
| Discussing a task with NI                                                   |         | 1:20 |   |   4.2 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |   9.3 |
| Studying different loops etc etc                                            |         | 0:32 |   |   1.7 |
| Writing a text base adventure                                               |         | 3:45 |   |  11.9 |
| Comparing NI and mines Text Adv                                             |         | 0:48 |   |   2.5 |
| Trying to get ERC to work                                                   |         | 1:11 |   |   3.7 |
| Writing Tic Tac Toe game                                                    |         | 2:50 |   |   9.0 |
