...
#+CAPTION: Clock summary at [2018-01-15 Mon 16:48]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *20:47* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 20:47   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   3.7 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  10.7 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   4.0 |
| Adding numbers on wt                                                        |         | 0:44 |   |   3.5 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   9.9 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   6.7 |
| Practice C++                                                                |         | 1:28 |   |   7.1 |
| Reading "Learn C++" chapter 1                                               |         | 2:00 |   |   9.6 |
| Cleaning up tasks.org                                                       |         | 0:16 |   |   1.3 |
| Making 21 game                                                              |         | 4:38 |   |  22.3 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   3.0 |
| Discussing a task with NI                                                   |         | 0:28 |   |   2.2 |
| Creating a simple shopping checkout                                         |         | 2:48 |   |  13.5 |
| Studying different loops etc etc                                            |         | 0:32 |   |   2.6 |
