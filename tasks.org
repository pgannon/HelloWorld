...
#+CAPTION: Clock summary at [2018-01-15 Mon 14:19]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *19:28* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 19:28   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   3.9 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  11.4 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   4.3 |
| Adding numbers on wt                                                        |         | 0:44 |   |   3.8 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |  10.5 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   7.2 |
| Practice C++                                                                |         | 1:28 |   |   7.5 |
| Reading "Learn C++" chapter 1                                               |         | 2:00 |   |  10.3 |
| Cleaning up tasks.org                                                       |         | 0:16 |   |   1.4 |
| Making 21 game                                                              |         | 4:38 |   |  23.8 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   3.2 |
| Discussing a task with NI                                                   |         | 0:28 |   |   2.4 |
| Creating a simple shopping checkout                                         |         | 1:29 |   |   7.6 |
| Studying different loops etc etc                                            |         | 0:32 |   |   2.7 |
