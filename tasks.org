...
#+CAPTION: Clock summary at [2018-01-22 Mon 15:00]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *48:55* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 48:55   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   1.6 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |   4.5 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   1.7 |
| Adding numbers on wt                                                        |         | 0:44 |   |   1.5 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   4.2 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   2.9 |
| Practice C++                                                                |         | 1:28 |   |   3.0 |
| Reading "Learn C++"                                                         |         | 6:23 |   |  13.0 |
| Cleaning/Updating tasks.org                                                 |         | 1:40 |   |   3.4 |
| Making 21 game                                                              |         | 4:38 |   |   9.5 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   1.3 |
| Discussing a task with NI                                                   |         | 3:10 |   |   6.5 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |   6.0 |
| Studying different loops etc etc                                            |         | 0:32 |   |   1.1 |
| Writing a text base adventure                                               |         | 5:03 |   |  10.3 |
| Comparing NI and mines Text Adv                                             |         | 0:48 |   |   1.6 |
| Trying to get ERC to work                                                   |         | 1:37 |   |   3.3 |
| Writing Tic Tac Toe game                                                    |         | 3:25 |   |   7.0 |
| Comparing NI and mines TicTacToe                                            |         | 0:12 |   |   0.4 |
| Look for C++ tasks online                                                   |         | 0:19 |   |   0.6 |
| Writing a Number Pyramid                                                    |         | 2:18 |   |   4.7 |
| Comparing NI and mines Pyramid                                              |         | 0:33 |   |   1.1 |
| Writing a Bar Chart                                                         |         | 3:32 |   |   7.2 |
| Comparing NI and mines Bar Charts                                           |         | 0:05 |   |   0.2 |
| Writing New RPG                                                             |         | 0:46 |   |   1.6 |
| Discussing NI and mines New RPG                                             |         | 0:52 |   |   1.8 |
