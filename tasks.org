...
#+CAPTION: Clock summary at [2018-01-15 Mon 13:47]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *18:56* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 18:56   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   4.0 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  11.7 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   4.4 |
| Adding numbers on wt                                                        |         | 0:44 |   |   3.9 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |  10.8 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   7.4 |
| Practice C++                                                                |         | 1:28 |   |   7.7 |
| Reading "Learn C++" chapter 1                                               |         | 2:00 |   |  10.6 |
| Cleaning up tasks.org                                                       |         | 0:16 |   |   1.4 |
| Making 21 game                                                              |         | 4:38 |   |  24.5 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   3.3 |
| Discussing a task with NI                                                   |         | 0:28 |   |   2.5 |
| Creating a simple shopping checkout                                         |         | 1:29 |   |   7.8 |
