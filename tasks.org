...
#+CAPTION: Clock summary at [2018-01-19 Fri 13:23]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *42:16* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 42:16   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   1.8 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |   5.2 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   2.0 |
| Adding numbers on wt                                                        |         | 0:44 |   |   1.7 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   4.9 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   3.3 |
| Practice C++                                                                |         | 1:28 |   |   3.5 |
| Reading "Learn C++"                                                         |         | 5:08 |   |  12.1 |
| Cleaning/Updating tasks.org                                                 |         | 1:15 |   |   3.0 |
| Making 21 game                                                              |         | 4:38 |   |  11.0 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   1.5 |
| Discussing a task with NI                                                   |         | 2:30 |   |   5.9 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |   7.0 |
| Studying different loops etc etc                                            |         | 0:32 |   |   1.3 |
| Writing a text base adventure                                               |         | 3:45 |   |   8.9 |
| Comparing NI and mines Text Adv                                             |         | 0:48 |   |   1.9 |
| Trying to get ERC to work                                                   |         | 1:37 |   |   3.8 |
| Writing Tic Tac Toe game                                                    |         | 3:25 |   |   8.1 |
| Comparing NI and mines TicTacToe                                            |         | 0:12 |   |   0.5 |
| Look for C++ tasks online                                                   |         | 0:19 |   |   0.7 |
| Writing a Number Pyramid                                                    |         | 2:18 |   |   5.4 |
| Comparing NI and mines Pyramid                                              |         | 0:33 |   |   1.3 |
| Writing a Bar Chart                                                         |         | 2:14 |   |   5.3 |
