...
#+CAPTION: Clock summary at [2018-01-16 Tue 16:04]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *26:13* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 26:13   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   2.9 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |   8.5 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   3.2 |
| Adding numbers on wt                                                        |         | 0:44 |   |   2.8 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   7.8 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   5.3 |
| Practice C++                                                                |         | 1:28 |   |   5.6 |
| Reading "Learn C++" chapter 1                                               |         | 2:33 |   |   9.7 |
| Cleaning up tasks.org                                                       |         | 0:38 |   |   2.4 |
| Making 21 game                                                              |         | 4:38 |   |  17.7 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   2.4 |
| Discussing a task with NI                                                   |         | 0:38 |   |   2.4 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |  11.3 |
| Studying different loops etc etc                                            |         | 0:32 |   |   2.0 |
| Writing a text base adventure                                               |         | 3:45 |   |  14.3 |
| Comparing NI and mines Text Adv                                             |         | 0:27 |   |   1.7 |
