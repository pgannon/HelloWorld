...
#+CAPTION: Clock summary at [2018-01-11 Thu 13:59]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *10:04* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 10:04   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   7.6 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  22.0 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   8.3 |
| Adding numbers on wt                                                        |         | 0:44 |   |   7.3 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |  20.4 |
| Attempt to use wt solo                                                      |         | 1:24 |   |  13.9 |
| Practice C++                                                                |         | 0:42 |   |   7.0 |
| Reading "Learn C++" chapter 1                                               |         | 1:22 |   |  13.6 |
...
-Completed Chapter 1
-Left the questions until the end. Did them after lunch
-Pretty confident reading the information
