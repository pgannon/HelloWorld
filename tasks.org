...
#+CAPTION: Clock summary at [2018-01-09 Tue 14:21]
| <75>                                                                        |        |      |   |       |
| Headline                                                                    | Time   |      |   |     % |
|-----------------------------------------------------------------------------+--------+------+---+-------|
...
|-----------------------------------------------------------------------------+--------+------+---+-------|
| Tasks                                                                       | 3:49   |      |   | 100.0 |
| Setup CMake                                                                 |        | 0:46 |   |  20.1 |
| Reviewing yesterdays Grades task                                            |        | 2:13 |   |  58.1 |
| Copy across hello world from wt (And how to run wt)                         |        | 0:50 |   |  21.8 |
