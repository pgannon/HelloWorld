...
#+CAPTION: Clock summary at [2018-01-12 Fri 12:40]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| *Total time*                                                                | *13:16* |      |   | 100.0 |
|-----------------------------------------------------------------------------+---------+------+---+-------|
| Tasks                                                                       | 13:16   |      |   | 100.0 |
| Setup CMake                                                                 |         | 0:46 |   |   5.8 |
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  16.7 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   6.3 |
| Adding numbers on wt                                                        |         | 0:44 |   |   5.5 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |  15.5 |
| Attempt to use wt solo                                                      |         | 1:24 |   |  10.6 |
| Practice C++                                                                |         | 1:28 |   |  11.1 |
| Reading "Learn C++" chapter 1                                               |         | 2:00 |   |  15.1 |
| Cleaning up tasks.org                                                       |         | 0:16 |   |   2.0 |
| Making 21 game                                                              |         | 1:32 |   |  11.6 |
