...
#+CAPTION: Clock summary at [2018-01-15 Mon 17:21]
| <75>                                                                        |         |      |   |       |
| Headline                                                                    | Time    |      |   |     % |
|-----------------------------------------------------------------------------+---------+------+---+-------|
...
| Reviewing yesterdays Grades task                                            |         | 2:13 |   |  10.6 |
| Copy across hello world from wt (And how to run wt)                         |         | 0:50 |   |   4.0 |
| Adding numbers on wt                                                        |         | 0:44 |   |   3.5 |
| Watch tutorials on youtube                                                  |         | 2:03 |   |   9.8 |
| Attempt to use wt solo                                                      |         | 1:24 |   |   6.7 |
| Practice C++                                                                |         | 1:28 |   |   7.0 |
| Reading "Learn C++" chapter 1                                               |         | 2:00 |   |   9.6 |
| Cleaning up tasks.org                                                       |         | 0:16 |   |   1.3 |
| Making 21 game                                                              |         | 4:38 |   |  22.1 |
| Comparing NI and mines 21 games                                             |         | 0:37 |   |   2.9 |
| Discussing a task with NI                                                   |         | 0:28 |   |   2.2 |
| Creating a simple shopping checkout                                         |         | 2:57 |   |  14.1 |
| Studying different loops etc etc                                            |         | 0:32 |   |   2.5 |
